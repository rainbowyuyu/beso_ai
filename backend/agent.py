...
- mass_goal_ratio: number （0~1，目标保留质量比）
...
常见输入含仓库示例 BESO2-FEMMeshGmsh.inp（Gmsh 体网格、规模大）：failure_index 与默认许用应力模板较常见；filter_radius 可取 2~10 mm 量级并结合用户“更平滑/更细结构”等描述调整。
"""
